...
{
    public partial class Table3Sales : Form
    {
        ...
        private void getSalesType()
        {
            var salesType = (from row in entities.SalesTypes
                             select row);
            List<ContViewModel4> ContAccesslist = new List<ContViewModel4>();
            ContViewModel4 c4 = new ContViewModel4();
            c4.id2 = 0;
            c4.Name2 = "";
            ContAccesslist.Add(c4);
            foreach (var type in salesType)
            {
                ContViewModel4 c2 = new ContViewModel4();
                c2.id2 = type.id;

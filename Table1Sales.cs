...
{
    public partial class Table1Sales : Form
    {
        ...
        private void getSalesType()
        {
            var salesType = (from row in entities.SalesTypes
                             select row);
            List<ContViewModel1> ContAccesslist = new List<ContViewModel1>();
            ContViewModel1 c4 = new ContViewModel1();
            c4.id2 = 0;
            c4.Name2 = "";
            ContAccesslist.Add(c4);
            foreach (var type in salesType)
            {
                ContViewModel1 c2 = new ContViewModel1();
                c2.id2 = type.id;

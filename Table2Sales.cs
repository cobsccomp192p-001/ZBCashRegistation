...
{
    public partial class Table2Sales : Form
    {
        ...
        private void getSalesType()
        {
            var salesType = (from row in entities.SalesTypes
                             select row);
            List<ContViewModel3> ContAccesslist = new List<ContViewModel3>();
            ContViewModel3 c4 = new ContViewModel3();
            c4.id2 = 0;
            c4.Name2 = "";
            ContAccesslist.Add(c4);
            foreach (var type in salesType)
            {
                ContViewModel3 c2 = new ContViewModel3();
                c2.id2 = type.id;
